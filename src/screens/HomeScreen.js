...
export default function HomeScreen({ onOpenExplore, onOpenProductDetail, onAddProduct }) {
      ...
      >
        ...
        {filteredFeaturedProducts.length > 0 ? (
          <View style={styles.section}>
            <SectionHeader title="Exclusive Offer" onPress={onOpenExplore} />
        ...
        {filteredBestSellingProducts.length > 0 ? (
          <View style={styles.section}>
            <SectionHeader title="Best Selling" onPress={onOpenExplore} />
        ...
        {filteredHighlights.length > 0 || filteredGroceryProducts.length > 0 ? (
          <View style={styles.section}>
            <SectionHeader title="Groceries" onPress={onOpenExplore} />
